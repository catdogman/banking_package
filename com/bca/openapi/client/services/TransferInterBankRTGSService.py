...
from com.bca.openapi.client.entity.transferinterbankrtgsresponse.TransferInterBankRTGSResponse import TransferInterBankRTGSResponse
...
class TransferInterBankRTGSService(BaseService):

    def processTransferInterBankRTGS(self, 
            external_id, 
            request):

        self.statement_path = '/openapi/v1.0/transfer-rtgs'        
        ...
        response = TransferInterBankRTGSResponse(response_data)
        return response
