...
from com.bca.openapi.client.entity.internalaccountinquiryresponse.InternalAccountInquiryResponse import InternalAccountInquiryResponse
...
class InternalAccountInquiryService(BaseService):

    def getInternalAccountInquiry(self, 
            external_id, 
            request):

        self.statement_path = '/openapi/v1.0/account-inquiry-internal'        
        ...
        response = InternalAccountInquiryResponse(response_data)
        return response
