...
from com.bca.openapi.client.entity.tolakankusknresponse.TolakanKUSKNResponse import TolakanKUSKNResponse
...
class TolakanKUSKNService(BaseService):

    def tolakanKUSKN(self, 
            external_id, 
            request):

        self.statement_path = '/openapi/v1.0/transfer-skn/notify'        
        ...
        response = TolakanKUSKNResponse(response_data)
        return response
