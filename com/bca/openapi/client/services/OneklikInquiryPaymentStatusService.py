...
from com.bca.openapi.client.entity.oneklikinquirypaymentstatusresponse.OneklikInquiryPaymentStatusResponse import OneklikInquiryPaymentStatusResponse
...
class OneklikInquiryPaymentStatusService(BaseService):

    def inquiryStatus(self, 
            external_id, 
            request):

        self.statement_path = '/openapi/oneklik/v1.0/debit/status'        
        ...
        response = OneklikInquiryPaymentStatusResponse(response_data)
        return response
