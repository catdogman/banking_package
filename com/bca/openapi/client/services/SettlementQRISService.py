...
from com.bca.openapi.client.entity.settlementqrisresponse.SettlementQRISResponse import SettlementQRISResponse
...
class SettlementQRISService(BaseService):

    def settlementQRIS(self, 
            external_id, 
            request):

        self.statement_path = '/openapi/v1.0/qr/qr-mpm-settlement'        
        ...
        response = SettlementQRISResponse(response_data)
        return response
