...
from com.bca.openapi.client.entity.accountstatementresponse.AccountStatementResponse import AccountStatementResponse
...
class AccountStatementService(BaseService):
    ...
    def getAccountStatement(self, 
        ...
        self.statement_path = '/openapi/v1.0/bank-statement'        
        ...
        response = AccountStatementResponse(response_data)
        return response
