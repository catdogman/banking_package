...
from com.bca.openapi.client.entity.inquiryqrisresponse.InquiryQRISResponse import InquiryQRISResponse
...
class InquiryQRISService(BaseService):

    def inquiryQRIS(self, 
            external_id, 
            request):

        self.statement_path = '/openapi/v1.0/qr/qr-mpm-query'        
        ...
        response = InquiryQRISResponse(response_data)
        return response
