...
from com.bca.openapi.client.entity.oneklikgeneratepaymentotpresponse.OneklikGeneratePaymentOTPResponse import OneklikGeneratePaymentOTPResponse
...
class OneklikGeneratePaymentOTPService(BaseService):

    def generateOTP(self, 
            external_id, 
            request):

        self.statement_path = '/openapi/oneklik/v1.0/otp'        
        ...
        response = OneklikGeneratePaymentOTPResponse(response_data)
        return response
