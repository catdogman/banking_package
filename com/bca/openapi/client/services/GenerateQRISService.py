...
from com.bca.openapi.client.entity.generateqrisresponse.GenerateQRISResponse import GenerateQRISResponse
...
class GenerateQRISService(BaseService):
    ...
    def generateQRIS(self, 
        ...
        response = GenerateQRISResponse(response_data)
        return response
