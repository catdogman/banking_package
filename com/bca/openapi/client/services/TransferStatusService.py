...
from com.bca.openapi.client.entity.transferstatusresponse.TransferStatusResponse import TransferStatusResponse
...
class TransferStatusService(BaseService):

    def getTransferStatus(self, 
            external_id, 
            request):

        self.statement_path = '/openapi/v1.0/transfer/status'        
        ...
        response = TransferStatusResponse(response_data)
        return response
