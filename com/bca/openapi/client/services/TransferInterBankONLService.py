...
from com.bca.openapi.client.entity.transferinterbankonlresponse.TransferInterBankONLResponse import TransferInterBankONLResponse
...
class TransferInterBankONLService(BaseService):

    def processTransferInterBankONL(self, 
            external_id, 
            request):

        self.statement_path = '/openapi/v1.0/transfer-interbank'        
        ...
        response = TransferInterBankONLResponse(response_data)
        return response
