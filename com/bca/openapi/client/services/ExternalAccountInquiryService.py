...
from com.bca.openapi.client.entity.externalaccountinquiryresponse.ExternalAccountInquiryResponse import ExternalAccountInquiryResponse
...
class ExternalAccountInquiryService(BaseService):

    def getExternalAccountInquiry(self, 
            external_id, 
            request):

        self.statement_path = '/openapi/v1.0/account-inquiry-external'        
        ...
        response = ExternalAccountInquiryResponse(response_data)
        return response
