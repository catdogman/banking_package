...
from com.bca.openapi.client.entity.oneklikaccountbindinginquiryresponse.OneklikAccountBindingInquiryResponse import OneklikAccountBindingInquiryResponse
...
class OneklikAccountBindingInquiryService(BaseService):

    def accountBindingInquiry(self, 
            external_id, 
            request):

        self.statement_path = '/openapi/oneklik/v1.0/registration-account-inquiry'        
        ...
        response = OneklikAccountBindingInquiryResponse(response_data)
        return response
