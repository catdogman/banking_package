...
from com.bca.openapi.client.entity.oneklikinquiryphonenumberotpresponse.OneklikInquiryPhoneNumberOTPResponse import OneklikInquiryPhoneNumberOTPResponse
...
class OneklikInquiryPhoneNumberOTPService(BaseService):

    def inquiryOTP(self, 
            external_id, 
            request):

        self.statement_path = '/openapi/oneklik/v1.0/payment/inquiry-phone-number'        
        ...
        response = OneklikInquiryPhoneNumberOTPResponse(response_data)
        return response
