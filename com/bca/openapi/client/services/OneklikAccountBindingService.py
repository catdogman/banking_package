...
from com.bca.openapi.client.entity.oneklikaccountbindingresponse.OneklikAccountBindingResponse import OneklikAccountBindingResponse
...
class OneklikAccountBindingService(BaseService):

    def accountBinding(self, 
            external_id,
            ip_address,
            device_id,            
            request):

        self.statement_path = '/openapi/oneklik/v1.0/registration-account-binding'        
        ...
        response = OneklikAccountBindingResponse(response_data)
        return response
