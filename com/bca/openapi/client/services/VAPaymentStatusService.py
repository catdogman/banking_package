...
from com.bca.openapi.client.entity.vapaymentstatusresponse.VAPaymentStatusResponse import VAPaymentStatusResponse
...
class VAPaymentStatusService(BaseService):

    def getVaPaymentStatus(self, 
            external_id, 
            request):

        self.statement_path = '/openapi/v1.0/transfer-va/status'        
        ...
        response = VAPaymentStatusResponse(response_data)
        return response
