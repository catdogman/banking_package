...
from com.bca.openapi.client.entity.vabillpresentmentresponse.VABillPresentmentResponse import VABillPresentmentResponse
...
class VABillPresentmentService(BaseService):

    def getInquiryBillPresentment(self, 
            external_id, 
            request):

        self.statement_path = '/openapi/v1.0/transfer-va/inquiry-intrabank'        
        ...
        response = VABillPresentmentResponse(response_data)
        return response
