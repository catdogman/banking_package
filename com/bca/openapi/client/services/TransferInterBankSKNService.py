...
from com.bca.openapi.client.entity.transferinterbanksknresponse.TransferInterBankSKNResponse import TransferInterBankSKNResponse
...
class TransferInterBankSKNService(BaseService):

    def processTransferInterBankSKN(self, 
            external_id, 
            request):

        self.statement_path = '/openapi/v1.0/transfer-skn'        
        ...
        response = TransferInterBankSKNResponse(response_data)
        return response
