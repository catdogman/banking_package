...
from com.bca.openapi.client.entity.accountbalanceresponse.AccountBalanceResponse import AccountBalanceResponse
...
class AccountBalanceService(BaseService):
    ...
    def getAccountBalance(self, 
        ...
        self.statement_path = '/openapi/v1.0/balance-inquiry'        
        ...
        response = AccountBalanceResponse(response_data)
        return response
