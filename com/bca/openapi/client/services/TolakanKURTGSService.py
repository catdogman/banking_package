...
from com.bca.openapi.client.entity.tolakankurtgsresponse.TolakanKURTGSResponse import TolakanKURTGSResponse
...
class TolakanKURTGSService(BaseService):

    def tolakanKURTGS(self, 
            external_id, 
            request):

        self.statement_path = '/openapi/v1.0/transfer-rtgs/notify'        
       ...
       timestamp = timestamp[:19] + timestamp[26:]
        ...
        response = TolakanKURTGSResponse(response_data)
        return response
