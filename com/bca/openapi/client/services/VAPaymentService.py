...
from com.bca.openapi.client.entity.vapaymentresponse.VAPaymentResponse import VAPaymentResponse
...
class VAPaymentService(BaseService):

    def getVaPayment(self, 
            external_id, 
            request):

        self.statement_path = '/openapi/v1.0/transfer-va/payment-intrabank'        
        ...
        response = VAPaymentResponse(response_data)
        return response
